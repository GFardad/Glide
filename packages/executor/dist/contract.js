...
export function generateAgentContract(workspace, agent) {
...
export function validateAgentContract(workspace, agentId) {
    const missing = [];
    const incomplete = [];
...
function hasExpectedSection(content, section) {
...
function loadAgentDirectory(workspace, agentId) {
