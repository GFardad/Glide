...
export class TracerRuntime {
    ...
    static MAX_TRACE_ENTRIES = 10_000;
    constructor(options = {}) {
    ...
    async recordTrace(campaignId, agentId, action, status, detail = "") {
...
export async function indepthAgent(options) {
