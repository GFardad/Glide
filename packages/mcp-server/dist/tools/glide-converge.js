...
export const glideConvergeTool = {
    name: "glide_converge",
    description: "Assess plan-vs-reality convergence: reads Plan/*.md, scans the codebase " +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            repo_root: {
                type: "string",
                description: "Root of the repository to scan. Defaults to campaign_dir parent when omitted.",
            },
            plan_dir: {
                type: "string",
                description: "Directory containing Plan/*.md files. Defaults to <campaign_dir>/plan.",
            },
            write_report: {
                type: "boolean",
                description: "When true, write the converge report to <campaign_dir>/artifacts/converge_report.md",
            },
        },
    ...
    handler: async (args) => {
        ...
        const repoRoot = args["repo_root"]?.trim() ||
            join(campaignDir, "..", "..");
        const planDir = args["plan_dir"]?.trim() ||
            join(campaignDir, "plan");
        const writeReport = args["write_report"] ?? false;
...
//# sourceMappingURL=glide-converge.js.map