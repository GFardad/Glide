...
export const glideGraphTool = {
    name: "glide_graph",
    description: "Query the Glide project knowledge graph (graphify) for relationships, shortest paths, communities, and PR impact.",
    inputSchema: {
        type: "object",
        properties: {
            action: {
    ...
    handler: async (args) => {
        ...
        try {
            ...
            if (action === "community") {
                const communityId = typeof args["community_id"] === "number"
                    ? args["community_id"]
            ...
            if (action === "pr_impact") {
                const prNumber = typeof args["pr_number"] === "number"
                    ? args["pr_number"]
...
//# sourceMappingURL=glide-graph.js.map